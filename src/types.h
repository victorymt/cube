...
#define DEFAULT_RENDER_DISTANCE_CHUNKS 6
#define MAX_RENDER_DISTANCE_CHUNKS 8
#define MAX_ACTIVE_CHUNKS ((MAX_RENDER_DISTANCE_CHUNKS * 2 + 1) * (MAX_RENDER_DISTANCE_CHUNKS * 2 + 1))
#define CHUNK_GEN_SUBMISSIONS_PER_FRAME 24
#define MAX_CHUNK_GEN_JOBS 64
#define MAX_MESH_REBUILDS_PER_FRAME 8
...
#define SPACE_LAYER_HEIGHT WORLD_HEIGHT
