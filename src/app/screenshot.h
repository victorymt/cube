...
typedef struct ScreenshotWeatherDebugInfo {
    ...
    bool firePresent;
    const char *firePhase;
    ScreenshotVector3 firePosition;
    float fireDistance;
    float fireIntensity;
    float fireFuel;
    float fireMoisture;
    float fireHeatOutput;
    float fireSmokeOutput;
    float fireLocalHeat;
    float fireLocalSmoke;
    float firePlumeWindAngle;
    float firePlumeWindDrift;
    float fireHaze;
    unsigned fireSnapshotCount;
    unsigned fireRenderMaxFires;
    unsigned fireRenderFlameTongues;
    unsigned fireRenderSmokePuffs;
    uint32_t fireIgnitions;
    uint32_t fireSpreadIgnitions;
    uint32_t fireExtinctions;
    uint32_t fireSuppressions;
    uint32_t fireBurnedBlocks;
    uint32_t fireBurnSiteCount;
    uint32_t fireRecoveredSites;
    uint32_t fireDroppedIgnitions;
    uint32_t fireDroppedBurnSites;
    bool damageEnabled;
