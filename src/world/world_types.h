...
typedef enum BlockType {
    ...
    BLOCK_STAGE05_START = BLOCK_ANDESITE,
    BLOCK_STAGE05_GEOLOGY_START = BLOCK_ANDESITE,
    BLOCK_STAGE05_GEOLOGY_END = BLOCK_PHOSPHATE_ROCK,
    BLOCK_STAGE05_BIOGENIC_START = BLOCK_CHERNOZEM,
    BLOCK_STAGE05_BIOGENIC_END = BLOCK_GUANO,
    BLOCK_FIRE_RESIDUE_START = BLOCK_CHARRED_WOOD,
    BLOCK_FIRE_RESIDUE_END = BLOCK_FIRE_ASH,
    BLOCK_STAGE05_END = BLOCK_FIRE_ASH,
    BLOCK_STAGE06_START = BLOCK_OAK_LOG,
    BLOCK_STAGE06_TREE_START = BLOCK_OAK_LOG,
    BLOCK_STAGE06_TREE_END = BLOCK_WILLOW_LEAVES,
    BLOCK_STAGE06_UNDERSTORY_START = BLOCK_BIG_BLUESTEM,
    BLOCK_STAGE06_UNDERSTORY_END = BLOCK_SAGUARO,
    BLOCK_STAGE06_END = BLOCK_SAGUARO,
    BLOCK_NATURAL_END = BLOCK_STAGE06_END,
...
typedef enum BlockTexture {
    ...
    TEX_CHARCOAL,
    TEX_FIRE_ASH,
    TEX_STAGE05_START = TEX_ANDESITE,
    TEX_STAGE05_END = TEX_FIRE_ASH,
    TEX_OAK_BARK,
    TEX_OAK_RING,
    TEX_OAK_LEAVES,
    TEX_BIRCH_BARK,
    ...
    TEX_FIREWEED,
    TEX_SAGUARO,
    TEX_STAGE06_START = TEX_OAK_BARK,
    TEX_STAGE06_END = TEX_SAGUARO,
    TEX_COUNT
} BlockTexture;
