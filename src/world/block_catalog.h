...
static const BlockCatalogEntry blockCatalog[BLOCK_NATURAL_END + 1] = {
    ...
    BLOCK_PHYS_ENTRY(BLOCK_ANDESITE, "Andesite", 105, 108, 109,
                     TEX_ANDESITE, 0.94f, 0.91f, 0.0f, 0.04f),
    BLOCK_PHYS_ENTRY(BLOCK_DIORITE, "Diorite", 165, 166, 162,
                     TEX_DIORITE, 0.95f, 0.92f, 0.0f, 0.03f),
    BLOCK_PHYS_ENTRY(BLOCK_RHYOLITE, "Rhyolite", 157, 132, 121,
                     TEX_RHYOLITE, 0.92f, 0.88f, 0.0f, 0.05f),
    BLOCK_PHYS_ENTRY(BLOCK_TUFF, "Tuff", 132, 126, 109, TEX_TUFF,
                     0.78f, 0.64f, 0.0f, 0.28f),
    BLOCK_PHYS_ENTRY(BLOCK_SCHIST, "Schist", 101, 103, 94, TEX_SCHIST,
                     0.91f, 0.85f, 0.0f, 0.08f),
    BLOCK_PHYS_ENTRY(BLOCK_SLATE, "Slate", 69, 79, 85, TEX_SLATE,
                     0.90f, 0.86f, 0.0f, 0.07f),
    BLOCK_PHYS_ENTRY(BLOCK_SERPENTINITE, "Serpentinite", 74, 108, 78,
                     TEX_SERPENTINITE, 0.88f, 0.82f, 0.0f, 0.08f),
    BLOCK_PHYS_ENTRY(BLOCK_DOLOMITE, "Dolomite", 180, 174, 159,
                     TEX_DOLOMITE, 0.89f, 0.84f, 0.0f, 0.06f),
    BLOCK_PHYS_ENTRY(BLOCK_GYPSUM, "Gypsum", 222, 216, 205, TEX_GYPSUM,
                     0.70f, 0.55f, 0.0f, 0.25f),
    BLOCK_PHYS_ENTRY(BLOCK_TRAVERTINE, "Travertine", 198, 177, 137,
                     TEX_TRAVERTINE, 0.82f, 0.70f, 0.0f, 0.18f),
    BLOCK_PHYS_ENTRY(BLOCK_BAUXITE, "Bauxite", 156, 75, 49, TEX_BAUXITE,
                     0.78f, 0.62f, 0.0f, 0.32f),
    BLOCK_PHYS_ENTRY(BLOCK_HEMATITE_ORE, "Hematite Ore", 132, 65, 55,
                     TEX_HEMATITE_ORE, 0.92f, 0.90f, 0.0f, 0.04f),
    BLOCK_PHYS_ENTRY(BLOCK_MAGNETITE_ORE, "Magnetite Ore", 54, 60, 62,
                     TEX_MAGNETITE_ORE, 0.94f, 0.93f, 0.0f, 0.03f),
    BLOCK_PHYS_ENTRY(BLOCK_PHOSPHATE_ROCK, "Phosphate Rock", 141, 132, 99,
                     TEX_PHOSPHATE_ROCK, 0.82f, 0.67f, 0.0f, 0.16f),
    BLOCK_PHYS_ENTRY(BLOCK_CHERNOZEM, "Chernozem", 48, 40, 31,
                     TEX_CHERNOZEM, 0.55f, 0.35f, 0.10f, 0.72f),
    BLOCK_PHYS_ENTRY(BLOCK_TERRA_ROSSA, "Terra Rossa", 134, 51, 34,
                     TEX_TERRA_ROSSA, 0.58f, 0.40f, 0.04f, 0.68f),
    BLOCK_PHYS_ENTRY(BLOCK_ALLUVIUM, "Alluvium", 126, 108, 80,
                     TEX_ALLUVIUM, 0.38f, 0.22f, 0.02f, 0.90f),
    BLOCK_PHYS_META_ENTRY(BLOCK_LEAF_LITTER, "Leaf Litter", 101, 72, 38,
                          TEX_LEAF_LITTER, BLOCK_RENDER_CARPET, 0.0f, true,
                          0.08f, 0.02f, 0.96f, 0.92f),
    BLOCK_PHYS_ENTRY(BLOCK_HUMUS, "Humus", 55, 43, 30, TEX_HUMUS,
                     0.45f, 0.30f, 0.65f, 0.78f),
    BLOCK_PHYS_ENTRY(BLOCK_COMPOST, "Compost", 72, 54, 35, TEX_COMPOST,
                     0.42f, 0.28f, 0.50f, 0.82f),
    BLOCK_PHYS_ENTRY(BLOCK_SHELL_BED, "Shell Bed", 203, 192, 163,
                     TEX_SHELL_BED, 0.58f, 0.42f, 0.0f, 0.70f),
    BLOCK_PHYS_ENTRY(BLOCK_CORAL_LIMESTONE, "Coral Limestone", 196, 181, 154,
                     TEX_CORAL_LIMESTONE, 0.85f, 0.76f, 0.0f, 0.12f),
    BLOCK_PHYS_ENTRY(BLOCK_GUANO, "Guano", 177, 164, 121, TEX_GUANO,
                     0.25f, 0.12f, 0.30f, 0.96f),
    BLOCK_PHYS_ENTRY(BLOCK_CHARRED_WOOD, "Charred Wood", 43, 34, 28,
                     TEX_CHARRED_WOOD, 0.65f, 0.50f, 0.0f, 0.14f),
    BLOCK_PHYS_ENTRY(BLOCK_CHARCOAL, "Charcoal", 31, 31, 29, TEX_CHARCOAL,
                     0.48f, 0.32f, 0.0f, 0.22f),
    BLOCK_PHYS_ENTRY(BLOCK_FIRE_ASH, "Fire Ash", 151, 147, 139,
                     TEX_FIRE_ASH, 0.18f, 0.08f, 0.0f, 0.98f)
};
