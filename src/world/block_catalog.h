...
static const BlockCatalogEntry blockCatalog[BLOCK_NATURAL_END + 1] = {
    ...
    BLOCK_PHYS_FACE_ENTRY(BLOCK_OAK_LOG, "Pedunculate Oak Log", 116, 82, 49,
                          TEX_OAK_BARK, TEX_OAK_RING, TEX_OAK_RING,
                          0.84f, 0.72f, 0.82f, 0.10f),
    BLOCK_PHYS_META_ENTRY(BLOCK_OAK_LEAVES, "Pedunculate Oak Leaves",
                          55, 118, 48, TEX_OAK_LEAVES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.24f, 0.16f, 0.82f, 0.28f),
    BLOCK_PHYS_FACE_ENTRY(BLOCK_BIRCH_LOG, "Silver Birch Log", 207, 202, 184,
                          TEX_BIRCH_BARK, TEX_BIRCH_RING, TEX_BIRCH_RING,
                          0.70f, 0.52f, 0.94f, 0.14f),
    BLOCK_PHYS_META_ENTRY(BLOCK_BIRCH_LEAVES, "Silver Birch Leaves",
                          92, 150, 58, TEX_BIRCH_LEAVES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.18f, 0.10f, 0.93f, 0.34f),
    BLOCK_PHYS_FACE_ENTRY(BLOCK_ASPEN_LOG, "European Aspen Log", 166, 174, 145,
                          TEX_ASPEN_BARK, TEX_ASPEN_RING, TEX_ASPEN_RING,
                          0.68f, 0.48f, 0.90f, 0.15f),
    BLOCK_PHYS_META_ENTRY(BLOCK_ASPEN_LEAVES, "European Aspen Leaves",
                          104, 151, 62, TEX_ASPEN_LEAVES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.15f, 0.09f, 0.90f, 0.36f),
    BLOCK_PHYS_FACE_ENTRY(BLOCK_SPRUCE_LOG, "Norway Spruce Log", 91, 65, 42,
                          TEX_SPRUCE_BARK, TEX_SPRUCE_RING, TEX_SPRUCE_RING,
                          0.82f, 0.66f, 0.88f, 0.09f),
    BLOCK_PHYS_META_ENTRY(BLOCK_SPRUCE_NEEDLES, "Norway Spruce Needles",
                          35, 82, 53, TEX_SPRUCE_NEEDLES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.30f, 0.18f, 0.86f, 0.20f),
    BLOCK_PHYS_FACE_ENTRY(BLOCK_PINE_LOG, "Scots Pine Log", 128, 73, 43,
                          TEX_PINE_BARK, TEX_PINE_RING, TEX_PINE_RING,
                          0.86f, 0.70f, 0.92f, 0.08f),
    BLOCK_PHYS_META_ENTRY(BLOCK_PINE_NEEDLES, "Scots Pine Needles",
                          48, 104, 59, TEX_PINE_NEEDLES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.34f, 0.20f, 0.94f, 0.18f),
    BLOCK_PHYS_FACE_ENTRY(BLOCK_WILLOW_LOG, "White Willow Log", 139, 122, 80,
                          TEX_WILLOW_BARK, TEX_WILLOW_RING, TEX_WILLOW_RING,
                          0.62f, 0.44f, 0.76f, 0.22f),
    BLOCK_PHYS_META_ENTRY(BLOCK_WILLOW_LEAVES, "White Willow Leaves",
                          86, 139, 67, TEX_WILLOW_LEAVES,
                          BLOCK_RENDER_CUBE, 1.0f, true,
                          0.13f, 0.08f, 0.78f, 0.44f),
    BLOCK_PHYS_META_ENTRY(BLOCK_BIG_BLUESTEM, "Big Bluestem", 93, 137, 67,
                          TEX_BIG_BLUESTEM, BLOCK_RENDER_CROSS, 0.0f, true,
                          0.10f, 0.04f, 0.96f, 0.58f),
    BLOCK_PHYS_META_ENTRY(BLOCK_BRACKEN, "Bracken", 66, 116, 52,
                          TEX_BRACKEN, BLOCK_RENDER_CROSS, 0.0f, true,
                          0.12f, 0.05f, 0.88f, 0.46f),
    BLOCK_PHYS_META_ENTRY(BLOCK_COMMON_REED, "Common Reed", 124, 148, 72,
                          TEX_COMMON_REED, BLOCK_RENDER_CROSS, 0.0f, true,
                          0.22f, 0.08f, 0.94f, 0.40f),
    BLOCK_PHYS_META_ENTRY(BLOCK_SPHAGNUM, "Sphagnum Moss", 91, 130, 67,
                          TEX_SPHAGNUM, BLOCK_RENDER_CARPET, 0.0f, true,
                          0.09f, 0.03f, 0.52f, 0.72f),
    BLOCK_PHYS_META_ENTRY(BLOCK_HEATHER, "Common Heather", 103, 111, 61,
                          TEX_HEATHER, BLOCK_RENDER_CROSS, 0.0f, true,
                          0.28f, 0.10f, 0.98f, 0.30f),
    BLOCK_PHYS_META_ENTRY(BLOCK_FIREWEED, "Fireweed", 94, 139, 70,
                          TEX_FIREWEED, BLOCK_RENDER_CROSS, 0.0f, true,
                          0.14f, 0.05f, 0.92f, 0.52f),
    BLOCK_PHYS_ENTRY(BLOCK_SAGUARO, "Saguaro", 65, 132, 69,
                     TEX_SAGUARO, 0.58f, 0.34f, 0.18f, 0.12f)
};
