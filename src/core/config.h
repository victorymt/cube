...
#define GREEDY_MESH_MAX_SPAN CHUNK_SIZE
#define GREEDY_MESH_SPHERICAL_MAX_SPAN 4
#define GREEDY_MESH_UV_STRIDE 32
...
#define MAX_CHUNK_WORKER_THREADS 8
#define MAX_BACKGROUND_WORKER_THREADS (MAX_CHUNK_WORKER_THREADS + 1)
