...
$(SHIP_STATE_TEST_TARGET): tests/test_ship_state.c src/ship.c src/ship.h src/ship_flight_controller.c src/ship_flight_controller.h src/ship_locator.c src/ship_locator.h
	$(CC) $(CFLAGS) $(RAYLIB_CFLAGS) -ffunction-sections -fdata-sections -Isrc -Wl,--gc-sections -o $@ tests/test_ship_state.c src/ship.c src/ship_flight_controller.c src/ship_locator.c -lm
