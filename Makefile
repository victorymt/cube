...
$(WEATHER_RUNTIME_TEST_TARGET): tests/test_weather_runtime.c src/world/weather.c src/world/weather.h src/world/weather_model.c src/world/weather_model.h src/presentation/weather_visual.c src/presentation/weather_visual.h
	$(CC) $(CFLAGS) $(RAYLIB_CFLAGS) -ffunction-sections -fdata-sections -Isrc -Wl,--gc-sections -o $@ tests/test_weather_runtime.c src/world/weather.c src/world/weather_model.c src/presentation/weather_visual.c -lm
...
$(BLOCK_ATLAS_TEST_TARGET): tests/test_block_atlas.c src/world/block_atlas.c src/world/block_atlas.h src/world/world_types.h src/world/world.c src/world/world.h
	$(CC) $(CFLAGS) -ffunction-sections -fdata-sections $(RAYLIB_CFLAGS) -Isrc -Wl,--gc-sections -o $@ tests/test_block_atlas.c src/world/block_atlas.c src/world/world.c $(RAYLIB_LIBS) -lm
...
$(CHUNK_STREAMING_TEST_TARGET): tests/test_chunk_streaming.c src/world/block_atlas.c src/world/block_atlas.h $(CHUNKS_FEATURE_SRC) src/world/chunks.h src/world/world_types.h src/world/world.c src/world/world.h
	$(CC) $(CFLAGS) -DCHUNKS_TESTING -ffunction-sections -fdata-sections $(RAYLIB_CFLAGS) -Isrc -Wl,--gc-sections -o $@ tests/test_chunk_streaming.c src/world/block_atlas.c $(CHUNKS_FEATURE_SRC) src/world/world.c $(RAYLIB_LIBS) -lm -pthread
...
$(TERRAIN_SCALE_TEST_TARGET): tests/test_terrain_scale.c src/world/terrain.c src/world/terrain.h src/world/subsurface.c src/world/subsurface.h $(CHUNKS_FEATURE_SRC) src/world/chunks.h src/world/world_types.h
	$(CC) $(CFLAGS) -DTERRAIN_TESTING -ffunction-sections -fdata-sections $(RAYLIB_CFLAGS) -Isrc -Wl,--gc-sections -o $@ tests/test_terrain_scale.c src/world/terrain.c src/world/subsurface.c $(CHUNKS_FEATURE_SRC) $(RAYLIB_LIBS) -lm -pthread
...
$(CHUNK_BENCHMARK_TARGET): tests/benchmark_chunks.c src/world/block_atlas.c src/world/block_atlas.h $(CHUNKS_FEATURE_SRC) src/world/chunks.h src/world/terrain.c src/world/terrain.h src/world/subsurface.c src/world/subsurface.h src/world/world.c src/world/world.h src/ecology/evolution_catalog.c src/ecology/evolution_catalog.h
	$(CC) $(CFLAGS) -ffunction-sections -fdata-sections $(RAYLIB_CFLAGS) -Isrc -Wl,--gc-sections -o $@ tests/benchmark_chunks.c src/world/block_atlas.c $(CHUNKS_FEATURE_SRC) src/world/terrain.c src/world/subsurface.c src/world/world.c src/ecology/evolution_catalog.c $(RAYLIB_LIBS) -lm -pthread
